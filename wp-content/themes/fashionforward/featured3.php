...
$category_id = get_category_by_slug( get_theme_mod('block_3_cat') );
...
<!--      <div class="fsection3-cat-title"><a href="--><?php //echo ($category_link); ?><!--">--><?php //echo get_theme_mod('block3_text', 'Category one'); ?><!--</a> </div>-->
    <div class="featured-title"><?php echo get_theme_mod('block3_text', 'Category one'); ?></div>

      <div class="featured-section3">

    <?php   $the_query = new WP_Query( $feat_cat ); while ( $the_query->have_posts() ) : $the_query->the_post();?>

        <div class="fsection3-post"> <a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_post_thumbnail( 'featured3-thumbnail' ); ?></a>
